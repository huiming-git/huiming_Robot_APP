...
extern volatile uint32_t g_robotapp_estimator_us;
extern volatile uint32_t g_robotapp_estimator_us_max;
extern volatile uint32_t g_robotapp_control_us;
extern volatile uint32_t g_robotapp_control_us_max;
...
extern volatile float g_robotapp_balance_kp;
extern volatile float g_robotapp_balance_ki;
extern volatile float g_robotapp_balance_kd;
extern volatile float g_robotapp_balance_int_limit;
extern volatile float g_robotapp_pitch_filter_alpha;
extern volatile float g_robotapp_pitch_output_alpha;
extern volatile float g_robotapp_pitch_kalman_q;
extern volatile float g_robotapp_pitch_kalman_r;
